...
mod tests {
    ...
    fn encodes_to_the_golden_vector() {
        ...
        assert_eq!(buf, GOLDEN, "\n  got: {}\n  want: {}", crate::presentation::formatter::hex(&buf), crate::presentation::formatter::hex(&GOLDEN));
    }
    ...
    fn decodes_the_golden_vector() {
        ...
        assert_eq!(crate::presentation::formatter::format_price(msg.price), "150.2500");
    }
